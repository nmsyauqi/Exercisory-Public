...
@section('content')
    ...
    <div class="relative min-h-screen bg-gray-300 font-mono text-gray-900 selection:bg-blue-700 selection:text-white sm:flex sm:justify-center sm:items-center">



        {{-- KONTEN UTAMA - SIMULASI JENDELA APLIKASI --}}
        <div class="p-6 mx-auto max-w-7xl lg:p-8 mt-16 sm:mt-0">
            ...
            <div class="bg-gray-300 border-t-4 border-l-4 border-white border-r-4 border-b-4 border-gray-700 shadow-[8px_8px_0_0_#000000] p-4 sm:p-8">
                ...
                {{-- TITLE BAR (Diubah untuk Proyek Gamifikasi) --}}
                <div class="bg-blue-700 text-white p-1.5 mb-6 border-t-2 border-l-2 border-blue-400 border-r-2 border-b-2 border-blue-900 shadow-inner">
                    <span class="font-bold text-sm">C:\SYSTEM\EXERCISORY.EXE</span>
                </div>

                {{-- Logo (Bisa diganti ikon proyek Anda, tapi kita pertahankan Laravel logo dari template) --}}
                <div class="flex justify-center">
                    <svg class="w-auto h-16 text-red-600" viewBox="0 0 62 65" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>    
                                <div>
                                    ...
                                    <p class="mt-4 text-sm leading-relaxed text-gray-700">
                                        Sistem Gamifikasi Kepatuhan Kesehatan untuk membantu Anda mencapai target kesehatan harian dengan cara
                                        yang seru.
                                    </p>
                                </div>
                            </div>
            ...
            <a href="{{ route('register') }}" class="scale-100 p-6 bg-gray-300 border-t-2 border-l-2 border-white border-r-2 border-b-2 border-gray-600 shadow-[2px_2px_0_0_#000000] flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-blue-700 active:border-r-2 active:border-b-2 active:border-white active:border-t-2 active:border-l-2 active:shadow-inner active:bg-gray-200">
                <div>
                    <div class="flex items-center justify-center w-16 h-16 rounded-full bg-gray-400 border-t border-l border-white border-r border-b border-gray-500">
                        <svg class="text-blue-700 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
                        </svg>
                    </div>
                    <h2 class="mt-6 text-xl font-bold text-gray-900">Daftar Akun Baru</h2>
                    <p class="mt-4 text-sm leading-relaxed text-gray-700">
            ...
            {{-- CARD 3: Masuk / Login --}}
            <a href="{{ route('login') }}" class="scale-100 p-6 bg-gray-300 border-t-2 border-l-2 border-white border-r-2 border-b-2 border-gray-600 shadow-[2px_2px_0_0_#000000] flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-blue-700 active:border-r-2 active:border-b-2 active:border-white active:border-t-2 active:border-l-2 active:shadow-inner active:bg-gray-200">
                <div>
                    <div class="flex items-center justify-center w-16 h-16 rounded-full bg-gray-400 border-t border-l border-white border-r border-b border-gray-500">
                        <svg class="text-blue-700 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <h2 class="mt-6 text-xl font-bold text-gray-900">Masuk / Login</h2>
                    <p class="mt-4 text-sm leading-relaxed text-gray-700">
        ...
        @auth {{-- TAMPILKAN INI HANYA JIKA PENGGUNA SUDAH LOGIN --}}
            ...
            <a href="{{ route('leaderboard') }}" class="scale-100 p-6 bg-gray-300 border-t-2 border-l-2 border-white border-r-2 border-b-2 border-gray-600 shadow-[2px_2px_0_0_#000000] flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-blue-700 active:border-r-2 active:border-b-2 active:border-white active:border-t-2 active:border-l-2 active:shadow-inner active:bg-gray-200">
                <div>
                    <div class="flex items-center justify-center w-16 h-16 rounded-full bg-gray-400 border-t border-l border-white border-r border-b border-gray-500">
                        <svg class="text-blue-700 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                           <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 013 3h-15a3 3 0 013-3m9 0v-4.5A3 3 0 0012 9.75h0A3 3 0 007.5 14.25v4.5m9 0v-4.5m0 4.5a3 3 0 01-3 3h-3a3 3 0 01-3-3m0 0v-4.5A3 3 0 0112 9.75h0A3 3 0 0116.5 14.25v4.5m-9-3.75h9" />
                        </svg>
                    </div>
            ...
            @if (strtolower(Auth::user()->role) === 'admin')
                {{-- CARD UNTUK ADMIN --}}
                <a href="{{ route('admin.tasks') }}" class="scale-100 p-6 bg-gray-300 border-t-2 border-l-2 border-white border-r-2 border-b-2 border-gray-600 shadow-[2px_2px_0_0_#000000] flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-blue-700 active:border-r-2 active:border-b-2 active:border-white active:border-t-2 active:border-l-2 active:shadow-inner active:bg-gray-200">
                    <div>
                        <div class="flex items-center justify-center w-16 h-16 rounded-full bg-gray-400 border-t border-l border-white border-r border-b border-gray-500">
                            <svg class="text-blue-700 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
            ...
            @else
                ...
                <a href="{{ route('participant.checklist') }}" class="scale-100 p-6 bg-gray-300 border-t-2 border-l-2 border-white border-r-2 border-b-2 border-gray-600 shadow-[2px_2px_0_0_#000000] flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-blue-700 active:border-r-2 active:border-b-2 active:border-white active:border-t-2 active:border-l-2 active:shadow-inner active:bg-gray-200">
                    <div>
                        <div class="flex items-center justify-center w-16 h-16 rounded-full bg-gray-400 border-t border-l border-white border-r border-b border-gray-500">
                            <svg class="text-blue-700 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                    ...
                    <div class="text-sm text-center text-gray-700 sm:text-left">
                        <div class="flex items-center gap-4">
                            <span class="inline-flex items-center group text-blue-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-5 h-5 mr-1 -mt-px stroke-gray-700" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                Proyek Gamifikasi
                            </span>
